...
@section('content')
    ...
    <tr>
        ...
        <td><img src="{{asset('uploads/images/subcategory/'.$sub->image)}}" class="image2" alt="" style="height: 100px; width: 100px; border: 15px solid white" ></td>

        <td>
            <a href="{{route('subcategory.view',$sub->id)}}" class="btn btn-sm btn-primary">
                <i class="fa fa-eye"></i>

            </a>
            <a href="{{route('subcategory.edit',$sub->id)}}" class="btn btn-sm btn-warning">                <i class="fa fa-pencil-alt"></i>
            </a>
