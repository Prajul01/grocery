            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach( $data['rows'] as $i=>$pro)
                    <tr>
                        ...
                        <td> {!!$pro->condition  !!}</td>
                        <td>
                            <a href="{{route('policy.show',$pro->id)}}" class="btn btn-sm btn-success">
                                <i class="fa fa-eye"></i>
                            ...
                            <a href="{{route('policy.edit',$pro->id)}}" class="btn btn-sm btn-primary">
                                <i class="fa fa-pencil-alt"></i>
                                </a>
                            <form class="d-inline" action="{{route('policy.destroy',$pro->id)}}" method="post">
