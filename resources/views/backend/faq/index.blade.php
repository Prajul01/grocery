            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($data['rows'] as $i=>$faq)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('faq.show',$faq->id)}}" class="btn btn-sm btn-primary">
                                <i class="fa fa-eye"></i>

                            </a>
                            <a href="{{route('faq.edit',$faq->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-pencil-alt"></i></a>
