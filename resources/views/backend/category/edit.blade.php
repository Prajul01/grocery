...
@section('content')
    ...
    <!-- general form elements -->
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form method="post" action="{{route('category.update',$data['row']->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name=" name"
                                   placeholder="Enter your name" value="{{$data['row']->name}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{asset('uploads/images/category/'.$data['row']->image)}}" class="image2" alt=""
